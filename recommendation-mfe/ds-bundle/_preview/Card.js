...
To suppress this warning, you need to explicitly provide the \`palette.${key}Channel\` as a string (in rgb format, for example "12 12 12") or undefined if you want to remove the channel token.`);
  ...
  var Typography = /* @__PURE__ */ React11.forwardRef(function Typography2(inProps, ref) {
    const {
      color: color2,
      ...themeProps
    } = useDefaultProps2({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TypographyRoot, {
      as: Component,
      ref,
      className: clsx_default(classes.root, className),
      ...other,
  ...
  function Basico() {
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ds_exports.Card, { title: "Introdução ao React", subtitle: "Artigo • 5 min de leitura", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Typography_default, { variant: "body2", color: "text.secondary", children: "Aprenda os conceitos fundamentais do React, incluindo componentes, props e estado." }) });
  }
  function ComAcoes() {
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
      ds_exports.Card,
      {
        ...
        subtitle: "Curso • Intermediário",
        actions: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(Stack_default, { direction: "row", spacing: 1, children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ds_exports.Button, { variant: "outlined", size: "small", children: "Salvar" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ds_exports.Button, { variant: "contained", size: "small", children: "Acessar" })
        ] }),
        children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Typography_default, { variant: "body2", color: "text.secondary", children: "Domine TypeScript do zero ao avançado com projetos práticos e exemplos reais." })
      }
    );
  }
  function Outlined() {
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ds_exports.Card, { title: "Docker para Iniciantes", subtitle: "Vídeo • 45 min", variant: "outlined", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Typography_default, { variant: "body2", color: "text.secondary", children: "Containerize suas aplicações com Docker e Docker Compose de forma simples e eficiente." }) });
  }
