var __dsPreview = (() => {
  ...
  // .design-sync/previews/SearchBar.tsx
...
To suppress this warning, you need to explicitly provide the \`palette.${key}Channel\` as a string (in rgb format, for example "12 12 12") or undefined if you want to remove the channel token.`);
  ...
  function Padrao() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.SearchBar, { placeholder: "Buscar recursos de aprendizagem..." });
  }
  function ComValor() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.SearchBar, { value: "React", placeholder: "Buscar recursos..." });
  }
  function Largo() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Stack_default, { sx: { width: "100%", maxWidth: 600 }, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.SearchBar, { placeholder: "Buscar cursos, artigos, vídeos e mais..." }) });
  }
  return __toCommonJS(SearchBar_exports);
})();
