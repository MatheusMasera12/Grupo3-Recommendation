var __dsPreview = (() => {
  ...
  // .design-sync/previews/UserProfileCard.tsx
  var UserProfileCard_exports = {};
  __export(UserProfileCard_exports, {
    ComEmail: () => ComEmail,
    ComFoto: () => ComFoto,
    Minimal: () => Minimal,
    Multiplos: () => Multiplos,
...
To suppress this warning, you need to explicitly provide the \`palette.${key}Channel\` as a string (in rgb format, for example "12 12 12") or undefined if you want to remove the channel token.`);
  ...
  function Minimal() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.UserProfileCard, { name: "Rafael Reis" });
  }
  function ComEmail() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      ds_exports.UserProfileCard,
  ...
  function NomeComposto() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      ds_exports.UserProfileCard,
      {
        name: "João Pedro Almeida da Silva",
  ...
  function Multiplos() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Stack_default, { spacing: 2, sx: { maxWidth: 400 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.UserProfileCard, { name: "Ana Souza", email: "ana@empresa.com", role: "Frontend", avatarUrl: "https://i.pravatar.cc/150?img=47" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.UserProfileCard, { name: "Carlos Mendes", email: "carlos@empresa.com", role: "Backend" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.UserProfileCard, { name: "Maria Oliveira", email: "maria@empresa.com", role: "Design", avatarUrl: "https://i.pravatar.cc/150?img=25" })
    ] });
  }
  return __toCommonJS(UserProfileCard_exports);
})();
