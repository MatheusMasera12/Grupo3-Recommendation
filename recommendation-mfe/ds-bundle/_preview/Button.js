var __dsPreview = (() => {
  ...
  __export(Button_exports, {
    ...
    Cores: () => Cores,
    Estados: () => Estados,
    TamanhoCompleto: () => TamanhoCompleto,
    Tamanhos: () => Tamanhos,
    Variantes: () => Variantes
  });
  init_define_import_meta_env();
...
For example, \`@sm\` or \`@600\` or \`@40rem/sidebar\`.` : formatMuiErrorMessage(18, `(${shorthand})`));
  ...
  init_define_import_meta_env();
  var import_react_is2 = __toESM(require_react_is_shim());
...
The following color spaces are supported: srgb, display-p3, a98-rgb, prophoto-rgb, rec-2020.` : formatMuiErrorMessage(10, colorSpace));
  ...
  function createStack(options = {}) {
    ...
    const Stack2 = /* @__PURE__ */ React8.forwardRef(function Grid(inProps, ref) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(StackRoot, {
        as: component,
        ownerState,
        ref,
...
To suppress this warning, you need to explicitly provide the \`palette.${key}Channel\` as a string (in rgb format, for example "12 12 12") or undefined if you want to remove the channel token.`);
  ...
  function DefaultPropsProvider2(props) {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(DefaultPropsProvider_default, {
      ...props
    });
  }
  ...
  var SvgIcon = /* @__PURE__ */ React11.forwardRef(function SvgIcon2(inProps, ref) {
    ...
    const hasSvgAsChild = /* @__PURE__ */ React11.isValidElement(children) && children.type === "svg";
    const ownerState = {
      ...props,
      color: color2,
      component,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(SvgIconRoot, {
      as: component,
      className: clsx_default(classes.root, className),
      focusable: "false",
      color: htmlColor,
      ...
      ownerState,
      children: [hasSvgAsChild ? children.props.children : children, titleAccess ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("title", {
  ...
  function createSvgIcon(path, displayName) {
    function Component(props, ref) {
      return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(SvgIcon_default, {
    ...
    return /* @__PURE__ */ React12.memo(/* @__PURE__ */ React12.forwardRef(Component));
  }
  ...
  var Add_default = createSvgIcon(/* @__PURE__ */ (0, import_jsx_runtime7.jsx)("path", {
  ...
  var AutoAwesome_default = createSvgIcon(/* @__PURE__ */ (0, import_jsx_runtime9.jsx)("path", {
  ...
  var Delete_default = createSvgIcon(/* @__PURE__ */ (0, import_jsx_runtime10.jsx)("path", {
  ...
  function Variantes() {
    return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(Stack_default, { direction: "row", spacing: 2, flexWrap: "wrap", useFlexGap: true, children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ds_exports.Button, { variant: "contained", color: "primary", children: "Confirmar" }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ds_exports.Button, { variant: "outlined", color: "primary", children: "Cancelar" }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ds_exports.Button, { variant: "text", color: "primary", children: "Ver mais" })
    ] });
  }
  function Cores() {
    return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(Stack_default, { direction: "row", spacing: 2, flexWrap: "wrap", useFlexGap: true, children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ds_exports.Button, { variant: "contained", color: "primary", children: "Primário" }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ds_exports.Button, { variant: "contained", color: "secondary", children: "Secundário" }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ds_exports.Button, { variant: "contained", color: "success", children: "Sucesso" }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ds_exports.Button, { variant: "contained", color: "error", children: "Erro" }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ds_exports.Button, { variant: "contained", color: "warning", children: "Atenção" })
    ] });
  }
  function ComIcones() {
    return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(Stack_default, { direction: "row", spacing: 2, flexWrap: "wrap", useFlexGap: true, children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ds_exports.Button, { variant: "contained", startIcon: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Add_default, {}), children: "Adicionar material" }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ds_exports.Button, { variant: "outlined", startIcon: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Search_default, {}), children: "Buscar recursos" }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ds_exports.Button, { variant: "contained", startIcon: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(AutoAwesome_default, {}), color: "secondary", children: "Ver recomendações" }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ds_exports.Button, { variant: "outlined", color: "error", startIcon: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Delete_default, {}), children: "Excluir" })
    ] });
  }
  function Tamanhos() {
    return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(Stack_default, { direction: "row", spacing: 2, alignItems: "center", flexWrap: "wrap", useFlexGap: true, children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ds_exports.Button, { variant: "contained", size: "small", children: "Pequeno" }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ds_exports.Button, { variant: "contained", size: "medium", children: "Médio" }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ds_exports.Button, { variant: "contained", size: "large", children: "Grande" })
    ] });
  }
  function Estados() {
    return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(Stack_default, { direction: "row", spacing: 2, flexWrap: "wrap", useFlexGap: true, children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ds_exports.Button, { variant: "contained", children: "Normal" }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ds_exports.Button, { variant: "contained", disabled: true, children: "Desabilitado" }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ds_exports.Button, { variant: "contained", loading: true, children: "Carregando" })
    ] });
  }
  function TamanhoCompleto() {
    return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(Stack_default, { spacing: 2, sx: { maxWidth: 480 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ds_exports.Button, { variant: "contained", fullWidth: true, color: "primary", startIcon: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(AutoAwesome_default, {}), children: "Ver minhas recomendações" }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ds_exports.Button, { variant: "outlined", fullWidth: true, children: "Acessar todos os recursos" })
    ] });
  }
