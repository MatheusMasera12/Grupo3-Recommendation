...
To suppress this warning, you need to explicitly provide the \`palette.${key}Channel\` as a string (in rgb format, for example "12 12 12") or undefined if you want to remove the channel token.`);
  ...
  function Padrao() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.Navbar, { title: "Recomendações" });
  }
  function ComAcoes() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      ds_exports.Navbar,
      {
        ...
        actions: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Stack_default, { direction: "row", spacing: 1, children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.Button, { variant: "outlined", size: "small", sx: { color: "white", borderColor: "white" }, children: "Entrar" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.Button, { variant: "contained", size: "small", color: "secondary", children: "Cadastrar" })
        ] })
      }
    );
  }
  function ComMenu() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.Navbar, { title: "Recursos", onMenuClick: () => {
    } });
  }
