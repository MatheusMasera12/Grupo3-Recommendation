...
To suppress this warning, you need to explicitly provide the \`palette.${key}Channel\` as a string (in rgb format, for example "12 12 12") or undefined if you want to remove the channel token.`);
  ...
  function Variantes() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Stack_default, { spacing: 2, sx: { width: 320 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.Input, { label: "Nome", variant: "outlined", placeholder: "Digite seu nome" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.Input, { label: "E-mail", variant: "filled", placeholder: "exemplo@email.com" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.Input, { label: "Descrição", variant: "standard", placeholder: "Breve descrição" })
    ] });
  }
  function Estados() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Stack_default, { spacing: 2, sx: { width: 320 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.Input, { label: "Campo normal", variant: "outlined" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.Input, { label: "Com erro", variant: "outlined", error: true, helperText: "Campo obrigatório" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.Input, { label: "Desabilitado", variant: "outlined", disabled: true, value: "Valor fixo" })
    ] });
  }
  function MultiLinha() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      ds_exports.Input,
      {
        ...
        rows: 4,
        fullWidth: true,
        placeholder: "Descreva o conteúdo, objetivos e pré-requisitos deste recurso..."
      }
    );
  }
