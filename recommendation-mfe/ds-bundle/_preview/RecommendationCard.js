var __dsPreview = (() => {
  ...
  // .design-sync/previews/RecommendationCard.tsx
  var RecommendationCard_exports = {};
  __export(RecommendationCard_exports, {
    Artigo: () => Artigo,
    BaixaCompatibilidade: () => BaixaCompatibilidade,
    Curso: () => Curso,
    Ferramenta: () => Ferramenta,
    Interativo: () => Interativo,
    Livro: () => Livro,
    TodosOsTipos: () => TodosOsTipos,
    Video: () => Video
  });
  init_define_import_meta_env();
...
To suppress this warning, you need to explicitly provide the \`palette.${key}Channel\` as a string (in rgb format, for example "12 12 12") or undefined if you want to remove the channel token.`);
  ...
  function DefaultPropsProvider2(props) {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(DefaultPropsProvider_default, {
      ...props
    });
  }
  ...
  var makeRec = (id, score, type, name, reason, description) => ({
    id,
    resourceId: `res-${id}`,
    score,
    reason,
    ...
    resource: {
      ...
      description,
      type,
      url: type !== "book" ? "https://exemplo.com" : void 0,
      tags: [],
      createdAt: "2024-01-01T00:00:00Z",
      updatedAt: "2024-01-01T00:00:00Z"
    }
  ...
  var artigo = makeRec(
    ...
    0.95,
    "article",
    "React 19: Novidades e Server Components",
    "Baseado no seu interesse em React e desenvolvimento web moderno",
    "Explore as principais novidades do React 19 incluindo Server Components, Actions e melhorias de performance."
  );
  var curso = makeRec(
    "2",
    0.82,
    ...
    "Complementa seus conhecimentos em TypeScript e boas práticas de código",
    "Aprenda a estruturar aplicações escaláveis usando os princípios de Clean Architecture."
  );
  var video = makeRec(
    "3",
    0.75,
    ...
    "Alinhado com sua trilha de DevOps e infraestrutura",
    "Containerize e orquestre suas aplicações com Docker e Kubernetes do zero ao produção."
  );
  var livro = makeRec(
    "4",
    0.61,
    ...
    "Indicado com base no seu interesse em boas práticas de engenharia",
    "Uma leitura fundamental sobre princípios e práticas do desenvolvimento de software profissional."
  );
  var ferramenta = makeRec(
    "5",
    0.55,
    "tool",
    "Figma para Desenvolvedores",
    "Considerado relevante para colaboração entre design e desenvolvimento",
    "Entenda como trabalhar com arquivos Figma, extrair tokens de design e colaborar com designers."
  );
  var baixaComp = makeRec(
    "6",
    0.32,
    "article",
    "Introdução ao Machine Learning",
    "Conteúdo fora do seu foco atual, mas pode expandir seus horizontes",
    "Fundamentos de aprendizado de máquina com Python: regressão, classificação e clustering."
  );
  function Artigo() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.RecommendationCard, { recommendation: artigo });
  }
  function Curso() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.RecommendationCard, { recommendation: curso });
  }
  function Video() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.RecommendationCard, { recommendation: video });
  }
  function Livro() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.RecommendationCard, { recommendation: livro });
  }
  function Ferramenta() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.RecommendationCard, { recommendation: ferramenta });
  }
  function BaixaCompatibilidade() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.RecommendationCard, { recommendation: baixaComp });
  }
  function Interativo() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      ds_exports.RecommendationCard,
      {
        recommendation: artigo,
        onSelect: (id) => console.log("Selecionado:", id)
      }
    );
  }
  function TodosOsTipos() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Stack_default, { spacing: 2, sx: { maxWidth: 380 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.RecommendationCard, { recommendation: artigo }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.RecommendationCard, { recommendation: video }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.RecommendationCard, { recommendation: livro }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.RecommendationCard, { recommendation: ferramenta }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_exports.RecommendationCard, { recommendation: baixaComp })
    ] });
  }
  return __toCommonJS(RecommendationCard_exports);
})();
