...
function parseResourceFromBackend(item) {
  let type = "other";
...
async function updateResource(id, dto) {
  ...
  if (description !== void 0 && dto.type) {
...
export { RESOURCE_TYPE_COLORS as R, RESOURCE_TYPE_LABELS as a, api as b, createResource as c, deleteResource as d, fetchResources as f, parseResourceFromBackend as p, updateResource as u };
