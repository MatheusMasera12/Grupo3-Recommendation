...
import { r as reactExports } from './index-Bdu5awqg.js';
import { r as reactDomExports } from './index-C8MVGW9g.js';
...
const {Box,CircularProgress} = await importShared('@mui/material');

const RecommendationView = lazy(() => __vitePreload(() => import('./__federation_expose_RecommendationView-DXG5wz6m.js'),true?[]:void 0));
const ResourcePage = lazy(() => __vitePreload(() => import('./ResourcePage-DJC5Hw3-.js'),true?[]:void 0));
const NotFoundPage = lazy(() => __vitePreload(() => import('./NotFoundPage-C0ACaQ5D.js'),true?[]:void 0));
function PageLoader() {
...
function AppRoutes() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/", element: /* @__PURE__ */ jsxRuntimeExports.jsx(RecommendationView, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/resources", element: /* @__PURE__ */ jsxRuntimeExports.jsx(ResourcePage, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "*", element: /* @__PURE__ */ jsxRuntimeExports.jsx(NotFoundPage, {}) })
  ] }) });
}

const {ThemeProvider,CssBaseline} = await importShared('@mui/material');
