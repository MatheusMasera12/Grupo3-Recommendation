...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-BFDHvGiQ.js', import.meta.url).href),import:true,requiredVersion:'^19.0.0'},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-BZaECOz7.js', import.meta.url).href),import:true,requiredVersion:'^19.0.0'},'react-router-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-router-dom-DwBiGmOQ.js', import.meta.url).href),import:true,requiredVersion:'^6.0.0'},'@mui/material':{get:()=>()=>__federation_import(new URL('__federation_shared_@mui/material-BQi29m3q.js', import.meta.url).href),import:true,requiredVersion:'^6.0.0'},'@emotion/react':{get:()=>()=>__federation_import(new URL('__federation_shared_@emotion/react-CKozeCB7.js', import.meta.url).href),import:true,requiredVersion:'^11.0.0'},'@emotion/styled':{get:()=>()=>__federation_import(new URL('__federation_shared_@emotion/styled-GLLBg2Q2.js', import.meta.url).href),import:true,requiredVersion:'^11.0.0'}};
